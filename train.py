...
# train.py NO necesita cambios estructurales.
# MSELoss funciona igual para salidas de cualquier dimensión:
# calcula el error cuadrático medio sobre todos los valores (N×5),
# lo que equivale a entrenar las 5 salidas simultáneamente con un solo loss.
...
def entrenar(modelo, datos, epocas=500, lr=0.01, graficar=True):
    ...
    for epoca in range(epocas):
        ...
        if (epoca + 1) % 50 == 0:
            print(f'  Época [{epoca+1}/{epocas}] - Pérdida (MSE global): {perdida.item():.4f}')
